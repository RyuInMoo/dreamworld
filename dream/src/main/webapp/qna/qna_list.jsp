			...
			<section class="review_board">
	          ...
	          <tr>
	            <td colspan="6">
	                <span>
		                <% if(sid != null ) {%>
		                      <a href="http://localhost:9001/dream/qna/qna_list_proc.jsp">
		                <% }else{ %>  
		                      <a href="http://localhost:9001/dream/login/login.jsp" onclick="qnaWriteAlert()"> 
		                <% } %>
	           ...
	           <div style="text-align:center">
		            <span> 
		              <% if(pageNo != 1){ %>
		                <a href="http://localhost:9001/dream/qna/qna_list.jsp?pageNo=<%= pageNo-1%>">
