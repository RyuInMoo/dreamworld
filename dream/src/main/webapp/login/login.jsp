...
<head>
	...
	<!-- Custom styles for this template -->
	  <link href="http://localhost:9001/dream/css/login.css" rel="stylesheet">
</head>
	             ...
	             <div class="text-center">
					<main class="form-signin">
						  <form name="login_form" action="login_proc.jsp" method="post">
						    <img src="http://localhost:9001/dream/images/logo3.png">
						    ...
						    <div class="checkbox mb-3" style="font-size: 13px;">
						      <label>
						        <a href="http://localhost:9001/dream/login/forgotid.jsp">아이디 찾기</a>&nbsp;|
						        <a href="http://localhost:9001/dream/login/forgotpw.jsp">비밀번호 찾기</a>&nbsp;|
						        <a href="http://localhost:9001/dream/join/join.jsp">회원가입</a>    
						      </label>
						    </div>
