...
<head>
	...
	<link rel="stylesheet" href="http://localhost:9001/dream/css/entertainment.css">
</head>
			...
			<section class="attraction-top section about-2 position-relative1">
				<div class="container">
					...
					<div class="background">
						<div class="window">
							<div class="popup">
								<button id="close" ><img class="all-map" src="http://localhost:9001/dream/images/all_map.jpg"></button>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="attraction">
							<div id="attraction_img">
								<img src="http://localhost:9001/dream/images/aa.jpg" alt="의무실" class="img-attr">
							</div>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/bb.jpg" alt="전자오락실" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/cc.jpg" alt="기념품매장" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/dd.jpg" alt="고객센터" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/ee.jpg" alt="물품보관소" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/ff.jpg" alt="대여샾" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
