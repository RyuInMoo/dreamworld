					...
					<div class="row">
						<div class="attraction">
							<div id="attraction_img">
								<img src="http://localhost:9001/dream/images/bc.jpg" alt="발키리" class="img-attr">
							</div>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/cr.jpg" alt="크라크" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/dr.jpg" alt="드라켄" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/fa.jpg" alt="파에톤" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/mg.jpg" alt="메가드롭" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
...
<section class="attraction-top section about-2 position-relative">
	<div class="container">
		<div class="row">
			<div class="attraction">
				<div id="attraction_img">
					<img src="http://localhost:9001/dream/images/tc.jpg" alt="토네이도" class="img-attr">
				</div>
				<div id="attraction_text">
					<span class="h6 text-color">DreamWorld</span>
