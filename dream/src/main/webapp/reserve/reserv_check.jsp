...
<title>예매하기 | 드림월드</title>
	...
	<!-- 부트스트랩 css 사용 --> 
	<link rel="stylesheet" href="http://localhost:9001/dream/css/bootstrap.css">
	<!-- 부트스트랩 js 사용 --> 
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> 
	<script type="text/javascript" src="http://localhost:9001/dream/js/bootstrap.js"></script>
	
	<script src="http://code.jquery.com/jquery-3.2.1.min.js"></script>
	<link rel="stylesheet" href="http://localhost:9001/dream/css/reserv.css">
